...
function WelcomeScreen() {
  ...
  return (
    <main className="relative min-h-screen bg-gradient-hero overflow-hidden">
      ...
      {/* Floating hero image */}
      <div
        className="absolute right-0 top-1/2 -translate-y-1/2 w-[55%] max-w-[800px] h-[80vh] bg-cover bg-center opacity-40 lg:opacity-60 mix-blend-luminosity"
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-12 min-h-screen flex flex-col">
        ...
        <div className="flex items-center gap-4 animate-float">
          <img src={logo} alt="Açaí do Paraíso" width={80} height={80} className="h-20 w-20 object-contain drop-shadow-2xl" />
          <div>
        ...
        <div className="flex-1 flex flex-col justify-center max-w-2xl">
          ...
          <h2 className="font-display text-5xl md:text-7xl lg:text-8xl font-bold text-primary-foreground leading-[0.95] drop-shadow-lg">
            Toque, monte
            <br />
            <span className="text-tropical">e aproveite.</span>
          </h2>
          ...
          <div className="mt-10 grid sm:grid-cols-2 gap-5 max-w-2xl">
            <Link
              to="/cardapio"
              onClick={() => start("local")}
              className="group relative overflow-hidden rounded-3xl bg-card text-card-foreground p-8 shadow-card hover:shadow-glow transition-all hover:-translate-y-1 active:scale-95 border-2 border-transparent hover:border-primary"
            >
            ...
            <Link
              ...
              className="group relative overflow-hidden rounded-3xl bg-gradient-tropical text-tropical-foreground p-8 shadow-card hover:shadow-glow transition-all hover:-translate-y-1 active:scale-95 border-2 border-transparent"
            >
